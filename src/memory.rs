...
impl BootInfoFrameAllocator {
    ...
    ///
    /// This function is unsafe because the caller must gurantee that the passed memory mpa is
    /// valid.  The main requirement ist hat all frames that are marked as `USABLE` in it really
    /// are unused.
